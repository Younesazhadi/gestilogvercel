...
import { FileText, Receipt, FileCheck, Truck, Search, Eye, Printer, Mail, DollarSign } from 'lucide-react';
...
const Documents = () => {
  ...
  const [activeTab, setActiveTab] = useState<'documents' | 'cheques'>('documents');
